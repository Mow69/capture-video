...
while (capture_live.isOpened()):
    ...
    scale_width = float(screen_width)/float(frame_live_width)
    scale_height = float(screen_height)/float(frame_live_height)
    ...
    newX,newY = frame_live.shape[1]*img_scale, frame_live.shape[0]*img_scale
